...
while learnrate > lr_limit:
	...
	checkpointer = ModelCheckpoint(filepath='weightsK25_2_' + str(k) + '.hdf5', verbose=1, save_best_only=True)
	...
	model.load_weights('weightsK25_2_' + str(k) + '.hdf5')
	learnrate /= c_lr
	k=k+1
